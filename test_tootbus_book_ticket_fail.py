...
def test_tootbus_book_ticket_fail():
    ...
    driver.find_element("xpath", "//*[contains(text(), 'Tours')]").click()
    time.sleep(2)
    driver.execute_script("document.querySelector('.text-countries-c01').style.outline = '5px solid red';")
    driver.save_screenshot("./screens/step_003.png")
    assert False, "Le titre de la ville n'est pas égale à 'Rome'"
